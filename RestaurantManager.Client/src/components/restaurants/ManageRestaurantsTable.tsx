import { Building2, ChefHat, ExternalLink, MapPin, Pencil, Trash2 } from "lucide-react";
import type { Restaurant, RestaurantStatus } from "../../types/restaurants";
import { useNavigate } from "react-router-dom";

const initialRestaurants: Restaurant[] = [
  {
      id: "r1", name: "Bella Italia", location: "Sofia", status: "Open", cuisine: "Italian", imgUrl: "", ownerId: "", description: "" },
  { id: "r2", name: "Sushi World", location: "Plovdiv", status: "Closed", cuisine: "Japanese", imgUrl: "", ownerId: "", description: "" },
  { id: "r3", name: "Burger Palace", location: "Varna", status: "Open", cuisine: "American", imgUrl: "", ownerId: "", description: "" },
  { id: "r4", name: "Taco Fiesta", location: "Burgas", status: "Open", cuisine: "Mexican", imgUrl: "", ownerId: "", description: "" },
];
    ...
    return (
        ...
        <div className="flex items-center justify-between border-t border-slate-200 px-5 py-3 text-xs text-slate-600">
          ...
          <button
            ...
            onClick={() => setRows(initialRestaurants)}
          >
            Reset dummy data
          </button>
        </div>
...
function StatusPill({ status, classNames }: { status: RestaurantStatus; classNames: (...v: Array<string | undefined | false>) => string }) {
  const cls =
    status === "Open"
